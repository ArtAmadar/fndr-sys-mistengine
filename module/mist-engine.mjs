...
Hooks.once('init', function () {
  ...
  Actors.registerSheet('mist-engine', MistEngineActorSheet, {
    makeDefault: true,
    label: 'MIST_ENGINE.SheetLabels.Actor',
  });
  Items.unregisterSheet('core', ItemSheet);
  Items.registerSheet('mist-engine', MistEngineItemSheet, {
    makeDefault: true,
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.mistengine.rollItemMacro("${data.uuid}");`;
